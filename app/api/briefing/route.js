...
export async function POST(request) {
  try {
    ...
    const prompt = `You are an AI assistant for ChurnIQ. Generate a concise daily briefing in 2 sentences based on: ${JSON.stringify(body)}. Be specific and actionable.`
    ...
    return NextResponse.json({ briefing: 'Your ChurnIQ dashboard is ready.' })
  }
}
